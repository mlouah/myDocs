...
To build the final jar and optimize the mydocs application for production, run:
...
Unit tests are run by [Jest][]. They're located in [src/test/javascript/](src/test__/javascript/) and can be run with:
