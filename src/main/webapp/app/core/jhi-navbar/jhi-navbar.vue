<template>
  <b-navbar data-cy="navbar" toggleable="md" type="dark" class="bg-dark">
    <b-navbar-brand class="logo" b-link to="/">
      ...
      <span class="navbar-title">mydocs</span> <span class="navbar-version">{{ version }}</span>
    </b-navbar-brand>
    <b-navbar-toggle
      right
      ...
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown right id="entity-menu" v-if="authenticated" active-class="active" class="pointer" data-cy="entity">
          <span slot="button-content" class="navbar-dropdown-menu">
            ...
            <span class="no-bold">Manage documentation</span>
          </span>
...
.logo-img {
  height: 100%;
  background: url('../../../content/images/logo-mydocs.png') no-repeat center center;
