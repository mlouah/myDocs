...
export default class DocCollection extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllDocCollections();
  }
  ...
  public retrieveAllDocCollections(): void {
  ...
  public prepareRemove(instance: IDocCollection): void {
  ...
  public removeDocCollection(): void {
    this.docCollectionService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A DocCollection is deleted with identifier ' + this.removeId;
