...
import DomaineComponent from '@/entities/domaine/domaine.vue';
import DomaineClass from '@/entities/domaine/domaine.component';
...
describe('Component Tests', () => {
  describe('Domaine Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<DomaineClass>(DomaineComponent, {
        store,
        localVue,
    ...
    it('Should call load all on init', async () => {
      ...
      // WHEN
      comp.retrieveAllDomaines();
      await comp.$nextTick();

      // THEN
      expect(domaineServiceStub.retrieve.called).toBeTruthy();
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      ...
      // THEN
      expect(domaineServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(domaineServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(domaineServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
